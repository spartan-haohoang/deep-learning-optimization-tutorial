...
class TestDataValidation:
    ...
    def test_iris_data_structure(self):
        ...
        if iris_path.exists():
            ...
            required_columns = ['Sepal.Length', 'Sepal.Width', 'Petal.Length', 'Petal.Width', 'Species']
            ...
            assert actual_species.issubset(valid_species), f"Invalid species found: {actual_species - valid_species}"
    ...
    def test_root_cause_data_structure(self):
        ...
        if rca_path.exists():
            ...
            # Check required columns
            required_columns = [
                'ID', 'CPU_LOAD', 'MEMORY_LEAK_LOAD', 'DELAY', 
                'ERROR_1000', 'ERROR_1001', 'ERROR_1002', 'ERROR_1003', 'ROOT_CAUSE'
            ]
            for col in required_columns:
                assert col in df.columns, f"Column {col} should exist in root cause dataset"
            
            # Check data types
            numeric_columns = ['ID', 'CPU_LOAD', 'MEMORY_LEAK_LOAD', 'DELAY', 
            ...
            assert actual_causes.issubset(valid_causes), f"Invalid root causes found: {actual_causes - valid_causes}"
    ...
    def test_validation_functions(self):
        ...
        assert isinstance(rca_result, bool), "Root cause validation should return boolean"
